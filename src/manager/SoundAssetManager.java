...
public class SoundAssetManager {
    ...
    public static void initMusic() {
        ...
        String[] bruitages = {"levelup.wav", "BuckBumble.wav", "musicBoss.wav", "Sting_em_up.wav", "bossSpawn.wav","explosion.wav", "Slap.wav", "hit.wav", "soin.wav", "bossShoot.wav", "victory.wav"};
